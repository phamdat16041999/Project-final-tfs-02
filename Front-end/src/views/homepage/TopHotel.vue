<template>
  <div class="parentTopHotel">
    <div class="container">
      <div class="row">
        <div class="col-12 topHotelTitle">
          <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
              <h3>Top 9 highest rated hotels</h3>
              <p>
        ...
        <div class="col-12">
          <div class="row">
            <div class="col-xl-4 col-12" v-for="data, index in topHotel.topHotel" :key="index">
              <div class="article-container" @click="product(data)">
...
export default {
 ...
 methods: {
    product(data){
      console.log(data)
       this.$router.push('/hotel?id='+data.ID+'&&userid='+data.userID);
    }
  },
};
</script>
