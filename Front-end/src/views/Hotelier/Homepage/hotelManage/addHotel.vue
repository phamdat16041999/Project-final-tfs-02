  ...
  <div class="row">
    ...
    <form v-on:submit.prevent="CreateHotel" method="post" class="row">
      <div class="col-xl-6 col-12">
        ...
        <input type="text" class="form-control" required v-model="formData.address"/>
        <div class="row">
          <div class="col-8">
      ...
      <div class="col-xl-6 col-12">
        ...
        <textarea class="form-control" rows="4" required v-model="formData.description"></textarea>
      </div>
      ...
      <div class="col-12" v-for="index in hotel.count" :key="index">
        ...
        <div class="row">
          <div class="col-xl-3 col-12">
            ...
            <input type="text" class="form-control" required  v-model="formData.room[index].name"/>
          </div>
          <div class="col-xl-3 col-12">
